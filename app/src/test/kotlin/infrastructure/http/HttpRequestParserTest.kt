...
class HttpRequestParserTest :
    DescribeSpec({
        ...
        fun makeStream(raw: String) = BufferedInputStream(ByteArrayInputStream(raw.toByteArray(Charsets.ISO_8859_1)))

        fun makeStream(bytes: ByteArray) = BufferedInputStream(ByteArrayInputStream(bytes))
