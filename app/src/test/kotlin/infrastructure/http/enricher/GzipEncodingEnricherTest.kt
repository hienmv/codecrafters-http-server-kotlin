...
class GzipEncodingEnricherTest : DescribeSpec({

    fun makeRequest(headers: Map<String, String> = emptyMap()) = HttpRequest(
    ...
    fun makeResponse(body: ByteArray? = "data".toByteArray()) =
        HttpResponse(status = HttpStatus.OK_200, body = body)
